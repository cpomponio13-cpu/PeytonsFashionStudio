...
export const fashionChallenges:FashionChallenge[]=[
 ...
 {id:'party',title:'Party Sparkle',brief:'Create a fun party look. Think bold colour, a dressier shape and one detail that catches the light.',icon:'✨',targetStyles:[3,5],targetFeatures:['sequins','metallic-detail'],targetTops:[3,5],targetBottoms:[3],bonus:'Bold colour • dressy shape • sparkle'},
