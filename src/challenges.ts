...
export const fashionChallenges:FashionChallenge[]=[
 ...
 {id:'party',title:'Party Sparkle',brief:'Create a fun party look. Think bold colour, a dressier shape and one detail that catches the light.',icon:'✨',targetStyles:[3,5],targetFeatures:['sequins','metallic-detail'],targetTops:[2,3,5],targetBottoms:[3],bonus:'Bold colour • dressy shape • sparkle'},
 {id:'garden',title:'Garden Day',brief:'Design a fresh playful outfit for a day outdoors. Think light colour, an easy shape and a nature-inspired detail.',icon:'🌸',targetStyles:[6,2],targetFeatures:['floral-print','embroidery'],targetTops:[1,2,3],targetBottoms:[2,3],bonus:'Fresh colour • relaxed shape • nature detail'},
 {id:'street',title:'Street Style',brief:'Build a confident everyday look. Mix a strong colour with practical clothing and a graphic or useful detail.',icon:'🕶️',targetStyles:[4,5],targetFeatures:['pockets','stripes','colour-blocking'],targetTops:[1,4,5],targetBottoms:[1,2],bonus:'Strong colour • everyday shape • graphic detail'},
 {id:'classic',title:'Classic With A Twist',brief:'Create a polished outfit, then give it one unexpected detail. Think clean colour, neat shapes and a finishing touch.',icon:'🎀',targetStyles:[1,3],targetFeatures:['contrast-trim','belt','lace','ruffles'],targetTops:[2,3,5],targetBottoms:[1,3],bonus:'Polished colour • neat shape • special detail'},
]
