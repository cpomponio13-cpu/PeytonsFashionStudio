...
export const wardrobeUnlocks:WardrobeUnlock[]=[
 {category:'top',id:1,name:'Ruffle Blouse',rule:{kind:'starter'}},
 {category:'top',id:2,name:'Off-Shoulder Top',rule:{kind:'starter'}},
 {category:'top',id:3,name:'Fitted Cami',rule:{kind:'completed',count:1}},
 {category:'top',id:4,name:'Wrap Blouse',rule:{kind:'stars',count:3}},
 {category:'top',id:5,name:'One-Shoulder Top',rule:{kind:'completed',count:2}},
 {category:'top',id:6,name:'Strapless Top',rule:{kind:'threeStar',count:1}},
 {category:'bottom',id:1,name:'Tailored Trousers',rule:{kind:'starter'}},
 {category:'bottom',id:2,name:'Denim Jeans',rule:{kind:'starter'}},
 {category:'bottom',id:3,name:'Mini Skirt',rule:{kind:'completed',count:1}},
 {category:'bottom',id:4,name:'Dress Shorts',rule:{kind:'starter'}},
 {category:'bottom',id:5,name:'Draped Skirt',rule:{kind:'stars',count:4}},
 {category:'bottom',id:6,name:'Classic Leggings',rule:{kind:'completed',count:2}},
 {category:'bottom',id:7,name:'Flared Trousers',rule:{kind:'threeStar',count:1}},
 {category:'dress',id:1,name:'Off-Shoulder Mini Dress',rule:{kind:'starter'}},
 {category:'dress',id:2,name:'Fitted Mini Dress',rule:{kind:'completed',count:1}},
 {category:'dress',id:3,name:'Wide-Leg Jumpsuit',rule:{kind:'stars',count:3}},
 {category:'dress',id:4,name:'Party Dress',rule:{kind:'completed',count:2}},
 {category:'dress',id:5,name:'Cocktail Dress',rule:{kind:'stars',count:6}},
 {category:'dress',id:6,name:'Evening Dress',rule:{kind:'threeStar',count:1}},
 {category:'dress',id:7,name:'Statement Dress',rule:{kind:'stars',count:9}},
 {category:'jacket',id:1,name:'Longline Jacket',rule:{kind:'starter'}},
 {category:'jacket',id:2,name:'Cropped Jacket',rule:{kind:'completed',count:1}},
 {category:'jacket',id:3,name:'Classic Blazer',rule:{kind:'stars',count:4}},
 {category:'jacket',id:4,name:'Casual Jacket',rule:{kind:'completed',count:2}},
 {category:'jacket',id:5,name:'Fitted Jacket',rule:{kind:'stars',count:7}},
 {category:'jacket',id:6,name:'Statement Jacket',rule:{kind:'threeStar',count:1}},
 {category:'shoes',id:1,name:'Ankle Boots',rule:{kind:'starter'}},
 {category:'shoes',id:2,name:'Classic Shoes',rule:{kind:'starter'}},
 {category:'shoes',id:3,name:'Knee-High Boots',rule:{kind:'completed',count:1}},
 {category:'shoes',id:4,name:'Dress Shoes',rule:{kind:'stars',count:4}},
 {category:'shoes',id:5,name:'Fashion Boots',rule:{kind:'completed',count:2}},
 {category:'shoes',id:6,name:'Statement Shoes',rule:{kind:'threeStar',count:1}},
]
